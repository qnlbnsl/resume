...
function Projects({ pageType }: props) {
    ...
    const [blogPosts, setBlogPosts] = useState<Butter.Post<string, string>[] | undefined>([]);
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            ...
            if (pageType === "search") {
                ...
                try {
                    const posts = await butter.post.search(urlQuery);
                ...
                try {
                    if (pageType === "category") {
                        ...
                        const category = await butter.category.retrieve(slug);
